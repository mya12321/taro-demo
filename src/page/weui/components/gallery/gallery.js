...
class _C extends Taro.Component {
  ...
  render() {
    const { show, extClass, current, currentImgs, showDelete } = this.data
    return (
      <View
        className={
          'weui-gallery ' + (show ? 'weui-gallery_show' : '') + ' ' + extClass
        }
      >
        <View className="weui-gallery__info">
          {current + 1 + '/' + currentImgs.length}
        </View>
        <Swiper
          className="weui-gallery__img__wrp"
        ...
        {showDelete && (
          <View className="weui-gallery__opr">
            <Navigator
              href="javascript:"
