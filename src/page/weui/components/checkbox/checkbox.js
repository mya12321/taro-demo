import { Block, View, Checkbox, Icon, Radio } from '@tarojs/components'
  ...
  render() {
    ...
    return (
      <MpCell
        ...
        footerClass={!multi ? 'weui-check__ft_in-radio' : ''}
        iconClass={multi ? 'weui-check__hd_in-checkbox' : ''}
        extClass={
          'weui-check__label ' +
          outerClass +
          ' ' +
          extClass +
          ' ' +
          (!multi ? 'weui-cell_radio' : 'weui-cell_checkbox')
        }
        renderIcon={
          <Block>
            <View>
