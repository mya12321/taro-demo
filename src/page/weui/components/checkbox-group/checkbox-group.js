import { Block, CheckboxGroup, RadioGroup } from '@tarojs/components'
...
class _C extends Taro.Component {
  ...
  render() {
    const { extClass, multi } = this.data
    return (
      <Block>
        <CheckboxGroup
          className={extClass}
        ...
        <RadioGroup className={extClass} wx-else onChange={this.checkedChange}>
          {this.props.children}
        </RadioGroup>
      </Block>
    )
