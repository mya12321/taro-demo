...
import SetTabBar from './components/set-tab-bar/set-tab-bar'
import './index.scss'
...
class _C extends Taro.Component {
  ...
  render() {
    const { isSetTabBarPage, list } = this.data
    return isSetTabBarPage ? (
      <SetTabBar onUnmount={this.leaveSetTabBarPage}></SetTabBar>
    ) : (
                          ...
                          return (
                            <Block key="*item">
                              {page.url !== '@set-tab-bar' ? (
                                ...
                                <View
                                  className="navigator"
                                  onClick={this.enterSetTabBarPage}
                                >
                                  <View className="navigator-text">
                                    {page.zh}
                                  </View>
