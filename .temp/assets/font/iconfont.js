  ...
  var e,
    ...
    if (document.addEventListener) {
      if (~["complete", "loaded", "interactive"].indexOf(document.readyState)) setTimeout(e, 0);else {
        var t = function () {
          document.removeEventListener("DOMContentLoaded", t, false), e();
        };document.addEventListener("DOMContentLoaded", t, false);
      }
    } else document.attachEvent && (a = e, n = c.document, i = false, o = function () {
      i || (i = true, a());
    }, (l = function () {
      try {
    ...
    var e, t, a, n, i, o;(e = document.createElement("div")).innerHTML = l, l = null, (t = e.getElementsByTagName("svg")[0]) && (t.setAttribute("aria-hidden", "true"), t.style.position = "absolute", t.style.width = 0, t.style.height = 0, t.style.overflow = "hidden", a = t, (n = document.body).firstChild ? (i = a, (o = n.firstChild).parentNode.insertBefore(i, o)) : n.appendChild(a));
  });
}(window);