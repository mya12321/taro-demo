...
import { AtActionSheet, AtActionSheetItem, AtActivityIndicator, AtMessage, AtModal, AtModalHeader, AtModalContent, AtModalAction, AtProgress, AtSwipeAction, AtToast } from 'taro-ui';
...
export default class FeedbackPage extends Taro.Component {
  ...
  render() {
    return <View className="page">
        ...
        <AtActionSheet cancelText="取消" isOpened={this.state.isActionSheetOpened1} onClose={this.handleActionSheetClose.bind(this, 1)}>
        ...
        <AtActionSheet cancelText="取消" isOpened={this.state.isActionSheetOpened2} onClose={this.handleActionSheetClose.bind(this, 2)} title="清除位置信息后， 别人将不能查看到你">
          <AtActionSheetItem onClick={this.showToast.bind(this, '点击了按钮一')}>
            按钮一
          </AtActionSheetItem>
          <AtActionSheetItem onClick={this.showToast.bind(this, '点击了按钮二')}>
        ...
        <AtActionSheet cancelText="取消" isOpened={this.state.isActionSheetOpened3} onCancel={this.handleActionSheetCancel} onClose={this.handleActionSheetClose.bind(this, 3)} title="清除位置信息后， 别人将不能查看到你">
          <AtActionSheetItem onClick={this.showToast.bind(this, '点击了按钮一')}>
            按钮一
          </AtActionSheetItem>
          <AtActionSheetItem onClick={this.showToast.bind(this, '点击了按钮二')}>
