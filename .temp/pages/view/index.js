...
import { AtAvatar, AtBadge, AtButton, AtCountdown, AtCurtain, AtDivider, AtLoadMore, AtNoticebar, AtSteps, AtTag, AtTimeline } from 'taro-ui';
        ...
        <View className="doc-body">
          ...
          <View className="panel">
            ...
            <View className="panel__content">
              {/* 空心标签 */}
              <View className="example-item">
                {this.state.hollowTagList.map((item, index) => <View className="subitem" key={index}>
              ...
              {/* 实心标签 */}
              <View className="example-item">
                {this.state.solidTagList.map((item, index) => <View className="subitem" key={index}>
              ...
              {/* 空心标签（小） */}
              <View className="example-item">
                {this.state.hollowTagList2.map((item, index) => <View className="subitem" key={index}>
              ...
              {/* 实心标签（小） */}
              <View className="example-item">
                {this.state.solidTagList2.map((item, index) => <View className="subitem" key={index}>
          ...
          <View className="panel">
            ...
            <View className="panel__content">
              {/* 一般用法 */}
              <View className="example-item">
                <View className="demo-btn" onClick={this.handleCurtainClick.bind(this, true)}>显示幕帘</View>
              </View>
            </View>
          </View>
          ...
          <View className="panel">
            ...
            <View className="panel__content">
              {/* 一般用法 */}
              <View className="example-item">
                <Swiper indicatorColor="#999" indicatorActiveColor="#333" current={1} duration={500} interval={5000} circular autoplay indicatorDots preMargin="20">
