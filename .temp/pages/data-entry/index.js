...
import { AtCheckbox, AtImagePicker, AtInput, AtInputNumber, AtForm, AtRadio, AtRange, AtRate, AtSearchBar, AtSlider, AtSwitch, AtTextarea } from 'taro-ui';
          ...
          <View className="panel">
            ...
            <View className="panel__content">
              ...
              <View className="example-item">
                ...
                <AtInputNumber min={0} max={10} step={1} value={this.state.inputNumber1} onChange={this.handleNumberChange.bind(this, 'inputNumber1')} />
              </View>

              {/* 禁用 */}
              <View className="example-item">
                <View className="example-item__desc">禁用</View>
                <AtInputNumber disabled min={0} max={10} step={1} value={this.state.inputNumber2} onChange={this.handleNumberChange.bind(this, 'inputNumber2')} />
              </View>

              {/* 大尺寸 */}
              <View className="example-item">
                <View className="example-item__desc">大尺寸</View>
                <AtInputNumber size="lg" min={0} max={10} step={1} value={this.state.inputNumber3} onChange={this.handleNumberChange.bind(this, 'inputNumber3')} />
              </View>
            </View>
          </View>
          ...
          <View className="panel">
            ...
            <View className="panel__content">
              <View className="example-item">
                ...
                <AtRange value={[20, 60]} onChange={this.handleRangeChange.bind(this, 'rangeValue')} />
              </View>
            </View>
          </View>
            ...
            <View className="panel__content">
              <View className="example-item">
                ...
                {isWeapp || isAlipay ? <View>
                    ...
                    </View> : <View className="title-date">暂时仅支持小程序</View>}
              </View>
            </View>
          </View>
